...
echo ""
echo "Components:"
echo "  $BINARY_DIR/customer_db           - Customer DB (Rust; local/dev — PA3 on GCP uses Python, not deployed by deploy_to_vms.sh)"
...
echo "  1. ./$BINARY_DIR/customer_db   # or python_customer_db per deployment/README"
